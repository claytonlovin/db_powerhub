...
CREATE TABLE `tb_grupo_usuario` (
  ...
  CONSTRAINT `ID_USUARIO_fk` FOREIGN KEY (`ID_USUARIO`) REFERENCES `tb_usuario` (`ID_USUARIO`)
...
INSERT INTO `tb_grupo_usuario` VALUES (83,96,105,98),(84,96,101,98);
...
-- Dump completed on 2022-12-28 20:10:45
